...
fetch("https://raw.githubusercontent.com/BTJUNIN/Portifolio/refs/heads/main/curriculo-M%C3%A1rcio/data/dados.json")
    .then(res => res.json())
    .then(data => {
        // Hard Skills
        ...
        data.informaçõespessoais.forEach(info => {
            ...
            const paragrafo = `<p class="p-0 m-0" style="font-size: 12px"><strong>${key}</strong> ${value}</p>`;
